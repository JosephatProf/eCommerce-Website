...
if (isset($_POST['submit'])) {
	...
	if (!empty($pNo) && !empty($fname) && !empty($lname) && !empty($date)) {
		//Now can add patient details
		if (is_numeric($pNo)) {
			$sql1 = "SELECT pNo from patients";
			...
			if ($pNo == $patientNo) {
				...
				$sql = "INSERT INTO patients(pNo,pfName,plName,cName,dateTovisit) VALUES('$pNo','$fname','$lname','$clinic','$date')";
					$stmt = $db->query($sql);
					if ($stmt) {
						?>
					<script type="text/javascript">
			...
			?>
			<script type="text/javascript">
				alert('Patient number should be only integers')
			</script>
			<?php
		}
...
?>
    <div class="container">
      ...
      <div class="jumbotron">
        <h1 class="display-3">REGISTER PATIENT HERE</h1>
        ...
        <div class="container">
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-10">
		      <input type="text" class="form-control" id="pNo" placeholder="Enter patient No." name="pNo">
		    </div>
		  </div>
		  <div class="form-group">
		    <label class="control-label col-sm-2" for="fname">First Name:</label>
		    <div class="col-sm-10"> 
		      <input type="text" class="form-control" id="fname" placeholder="Enter patient first name" name="fname">
		    </div>
		  </div>
		  <div class="form-group">
		    <label class="control-label col-sm-2" for="lname">Last Name:</label>
		    <div class="col-sm-10"> 
		      <input type="text" class="form-control" id="lname" placeholder="Enter patient last name" name="lname">
		    </div>
		  </div>
		  <div class="form-group">
		    <label class="control-label col-sm-2" for="clinic">Clinic Name:</label>
